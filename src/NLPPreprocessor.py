...
class NLPPreprocessor:
    ...
    def lemmatize(self):
        ...
        def execute_lemmatize(row):
            ...
            # row["lemmatized_sentences"] = [ [word for word in sentence] for sentence in row["sentences_tokenized"]] 
            row["lemmatized_sentences"] = row["sentences_tokenized"] 
            return row
    ...
    def stop_words(self):
        ...
        def execute_stop_words(row):
            ...
            row["npl_text"] = row["lemmatized_sentences"]
            return row
    ...
    def words_to_str(self):
        def convert_words_to_str(row):
            ...
            return {"_id": row["_id"], "npl_text": row["npl_text"] }
